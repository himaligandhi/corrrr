    ...
    <div class="transactions">
        <div class="container">
            <div class="section-title text-center">
                <h1 style="color:#8B040B;"><u>RECENT TRANSACTIONS</u></h1>
                <p style="margin-top:50px;"> Since 2012,
                <span style="color:#8B040B;">COR</span>Financial Corp has been assisting companies with our Asset Based Lending (ABL) expertise by providing advisory services and the successful funding of commercial transactions. We are extremely thankful and fortunate to have worked with great companies from many different industries across North America successfully managing transactions in excess of $200,000,000. This is a sample listing  some of the transactions that have been involved in.         </p>
            </div><!-- end title -->
        </div> 
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <h3 style="color:#8b040b;"><u>Manufacturing Transactions</u></h3>
                    <ul style="list-style:square; font-size:1.2em;">
                    <li>$25,300,000-– Multi-National Holding Company (Consolidation of operation facilities including additional working capital)</li>
                    <li>$11,200,000 – Multi-National Operations (Operations loan facility)</li>
                    </ul>
                </div>
                <div class="col-lg-6">
                    <h3 style="color:#8b040b;"><u>Wholesale/Retail Distribution Transactions</u></h3>
                    <ul style="list-style:square; font-size:1.2em;">
                    <li>$250,000 - Consumer Products Distributor (revolving loan facility)</li>
                    <li>$750,000 - Food Importer (letter of credit provided to supplier for the production of products)</li>
                    </ul>
                </div>
            </div>
            <br>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <h3 style="color:#8b040b;"><u>Commercial Real Estate Transactions</u></h3>
                    <ul style="list-style:square; font-size:1.2em;">
                    <li>$250,000 – Medical Center (Revolving Loan Facility)</li>
                    <li>$1,350,000 – Commercial property purchase (1st mortgage for 12,000 sq ft commercial building)</li>
                    <li>$8,500,000 – Commercial property (leasehold improvements and working capital)</li>
                    <li>$6,250,000 – Development Power of Sale Purchase (Structured the sale of property in power-of-sale to large development company)</li>
                    </ul>
                </div>
                <div class="col-lg-6">
                    <h3 style="color:#8b040b;"><u>Automotive Transactions</u></h3>
                    <ul style="list-style:square; font-size:1.2em;">
                    <li>$2,000,000 – Used Auto Dealer (inventory line)</li>
                    <li>$1,500,000 - Non-Prime Leasing Company (Funds provided to refinance and grow lease portfolio)</li>
                    <li> $12,000,000 – Automotive Leasing Company (Structured & syndicated securitization facility)</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <h3 style="color:#8b040b;"><u>Hospitality/Restaurant Transactions</u></h3>
                    <ul style="list-style:square; font-size:1.2em;">
                    <li>$6,300,000 – Night Club & Recording Studio (bridge loan pending long-term funding)</li>
                    <li>$5,300,000 – Entertainment Center (Bridge Loan)</li>
