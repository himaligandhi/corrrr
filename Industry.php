...
<nav class="navbar navbar-expand-sm navbar-dark" style="margin-bottom: 15px;">
   <div class="container-fluid" style="border-top:0.5px solid #44444C; border-bottom: 0.5px solid #44444C;background-color: #ececed;">
    ...
    <!--Industry-->
    <div id="industry" class="section lb">
        <div class="container">
            <div class="section-title text-center" style="margin-top:10px;">
                <h1 style="color:#8B040B;"><u>INDUSTRIES</u></h1>
                <p style="margin-top:80px;">
                    At <span style="color:#8B040B;">COR</span>Financial, we focus on the industries we know!
            </div> <!--end Titloe-->
            <div class="row">
                <div class="col-md-4 col-sm-6">
                    <div class="our-team">
                        <div class="pic">
                            <img src="images/manufacturing.jpg" style="height:200px;">
                        </div>
                        <div class="team-content">
                            <h3 class="title">Manufacuring</h3>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="our-team">
                        <div class="pic">
                            <img src="images/WholesaleDistribution.jpg" style="height:200px;">
                        </div>
                        <div class="team-content">
                            <h3 class="title">Wholesale/Retail Trade & Distribution</h3>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="our-team">
                        <div class="pic">
                            <img src="images/AutomotiveFinancing.jpg" style="height:200px;">
                        </div>
                        <div class="team-content">
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6">
                    <div class="our-team">
                        <div class="pic">
                            <img src="images/CommercialRealEstate.jpg" style="height:200px;">
                        </div>
                        <div class="team-content">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="our-team">
                        <div class="pic">
                            <img src="images/Restaurant.jpg" style="height:200px;">
                        </div>
                        <div class="team-content">
                            <h3 class="title">Hospitality/Restaurants </h3>
                ...
                <div class="col-md-4 col-sm-6">
                    <!-- <div class="our-team">
                        <div class="pic">
                            <img src="images/CommercialRealEstate.jpg">
                        </div>
                        <div class="team-content">
                            <h3 class="title">Commerical Real Estate Development </h3>
